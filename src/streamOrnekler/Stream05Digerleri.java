...
public class Stream05Digerleri {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Faktoriyel2= " + faktoriyel2(34));
    ...
    public static double faktoriyel2(int n) {
        return DoubleStream
                .iterate(1, t -> t + 1)
                .limit(n)
                .reduce(1, (x, y) -> x * y); // kar topu yuvarlar gibi yapilan islemler
    }
    ...
    public static List<Double> doubleDiziCevirList() {
        ...
        Stream<Double> streamNotlar = Stream.of(notlar); // dizi'yi stream'a cevir
        return streamNotlar
                .skip(2) // ilk 2 degeri alma
                .filter(t -> t > 50.0) // 50 den buyuk olanlari al
                .collect(Collectors.toList()); // stream'i list'e cevir
    }
